...
# or short form
cargo run -p multi_transport_example -- client -t udp
```
...
# or short form
cargo run -p multi_transport_example -- client -t ws
```
...
# or short form
cargo run -p multi_transport_example -- client -t wt -c <DIGEST>
```

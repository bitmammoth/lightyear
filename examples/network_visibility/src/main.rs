...
//!   cargo run -p network_visibility -- server
//!
//!   # Connect via UDP (in another terminal)
//!   cargo run -p network_visibility -- client --transport udp
//!
//!   # Connect via WebTransport (copy cert digest from server output)
//!   cargo run -p network_visibility -- client --transport webtransport --cert <DIGEST>
//!
//!   # Connect via WebSocket
//!   cargo run -p network_visibility -- client --transport websocket
...
#[derive(Parser)]
#[command(name = "network_visibility")]

...
//!
//! Usage:
//!   cargo run -p priority -- server
//!   cargo run -p priority -- client --transport udp
//!   cargo run -p priority -- client --transport websocket
//!   cargo run -p priority -- client --transport webtransport --cert <DIGEST>

...
//!   cargo run -p multi_transport_replication_groups -- server
//!
//!   # Connect via UDP (in another terminal)
//!   cargo run -p multi_transport_replication_groups -- client --transport udp
//!
//!   # Connect via WebTransport (copy cert digest from server output)
//!   cargo run -p multi_transport_replication_groups -- client --transport webtransport --cert <DIGEST>
//!
//!   # Connect via WebSocket
//!   cargo run -p multi_transport_replication_groups -- client --transport websocket
...
#[derive(Parser)]
#[command(name = "multi_transport_replication_groups")]

...
//!   cargo run -p multi_transport_distributed_authority -- server
//!
//!   # Connect via UDP (in another terminal)
//!   cargo run -p multi_transport_distributed_authority -- client --transport udp
//!
//!   # Connect via WebTransport (copy cert digest from server output)
//!   cargo run -p multi_transport_distributed_authority -- client --transport webtransport --cert <DIGEST>
//!
//!   # Connect via WebSocket
//!   cargo run -p multi_transport_distributed_authority -- client --transport websocket
...
#[derive(Parser)]
#[command(name = "multi_transport_distributed_authority")]

...
//!
//! Usage:
//!   cargo run -p multi_transport_auth -- server
//!   cargo run -p multi_transport_auth -- client --transport udp
//!   cargo run -p multi_transport_auth -- client --transport websocket
//!   cargo run -p multi_transport_auth -- client --transport webtransport --cert <DIGEST>
...
#[derive(Parser)]
#[command(name = "multi_transport_auth")]

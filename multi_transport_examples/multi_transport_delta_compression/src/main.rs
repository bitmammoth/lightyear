...
//!
//! Usage:
//!   cargo run -p multi_transport_delta_compression -- server
//!   cargo run -p multi_transport_delta_compression -- client --transport udp
//!   cargo run -p multi_transport_delta_compression -- client --transport websocket
//!   cargo run -p multi_transport_delta_compression -- client --transport webtransport --cert <DIGEST>
...
#[derive(Parser)]
#[command(name = "multi_transport_delta_compression")]
